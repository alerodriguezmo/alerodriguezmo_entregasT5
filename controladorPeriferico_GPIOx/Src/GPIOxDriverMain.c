 ...
 * **********************************************************************************
 *
 * Con este programa se desa mostrar el uso básico de los registros que controlan
 * al Micro (SFR) y la dorma adecuada para utilizar los operadores &, |, - y =, para
 ...
 *
 * Cada PINx de cada puerto GPIO puede desarrollar funciones básixas de tipo entrada
 ...
 * 	- Tpio de entrada (pull-up, pull-down, open drain (flotante))
...
int main(void){
	...
	GPIO_WritePin(&handlerUserLedPin);
