...
//    //Configuracion del timer para el muestreo a 1kHz
    ...
    handlerPinPwmX.GPIO_PinConfig.GPIO_PinOType            = GPIO_OTYPE_OPENDRAIN;
    ...
    handlerPinPwmY.GPIO_PinConfig.GPIO_PinOType            = GPIO_OTYPE_OPENDRAIN;
    ...
    handlerPinPwmZ.GPIO_PinConfig.GPIO_PinOType            = GPIO_OTYPE_OPENDRAIN;
