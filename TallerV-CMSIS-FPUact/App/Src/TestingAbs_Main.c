...
int8_t coordinates[6];//Array donde se van a actualizar los datos cada mS de las coordenadas
...
//        if(setPwmf){
//        	updateDuttyCycle(&handlerPwmX,coordinates[0]+32767);
//        	updateDuttyCycle(&handlerPwmY,coordinates[1]+32767);
//        	updateDuttyCycle(&handlerPwmZ,coordinates[2]+32767);
//        	setPwmf = 0;
//        }
    }
}
...
//    coordinates[0] = i2c_readSingleRegister(&handlerAccelerometer, ACCEL_XOUT_H);
//    coordinates[1] = i2c_readSingleRegister(&handlerAccelerometer, ACCEL_XOUT_L);
//    coordinates[2] = i2c_readSingleRegister(&handlerAccelerometer, ACCEL_YOUT_H);
//    coordinates[3] = i2c_readSingleRegister(&handlerAccelerometer, ACCEL_YOUT_L);
//    coordinates[4] = i2c_readSingleRegister(&handlerAccelerometer, ACCEL_ZOUT_H);
//    coordinates[5] = i2c_readSingleRegister(&handlerAccelerometer, ACCEL_ZOUT_L);
	coordinates[0] = -52;
	    coordinates[1] = -49;
	    coordinates[2] = -30;
	    coordinates[3] = 100;
        ...
        if(cont2i>0){
            coordinatex[cont2i-1] = coordinates[0]<<8|coordinates[1];
            coordinatey[cont2i-1] = coordinates[2]<<8|coordinates[3];
            coordinatez[cont2i-1] = coordinates[4]<<8|coordinates[5];
        }
    coordinatesbool = 0;
}
void initSystem(void){
...
//    //Configuracion del timer para el muestreo a 1kHz
    ...
    handlerMuestreo.TIMx_Config.TIMx_speed                = BTIMER_SPEED_1ms;;//porque el reloj principal está a 80MHz
    ...
    handlerAccelerometer.modeI2C            = I2C_MODE_SM;
