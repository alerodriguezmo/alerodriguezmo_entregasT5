...
#define HSE_CLOCK-SPEED			4000000			// Value for the main clock signal (HSE -> High Speed External)
 ...
 */
#define APB1_BASE ADDR			0x40000000U
#define APB2_BASE ADDR			0x40010000U
#define AHB1_BASE ADDR			0x40020000U
#define AHB2_BASE ADDR			0x50000000U
...
typedef struct
{
	...
	volatile uint32_t CIR; 	ADDR_OFFSET:				// Clock Interrupt register						ADDR_OFFSET:	0x0C
	volatile uint32_t AHB1RSTR;			// AHB1 Peripheral reset register				ADDR_OFFSET:	0x10
	volatile uint32_t AHB1RSTR;			// AHB2 Peripheral reset register				ADDR_OFFSET:	0x14
	...
	volatile uint32_t AHB1LPENR;		// AHB2 clock enable low power register			ADDR_OFFSET:	0x54
...
/* ==========	FIN de la descripición de los elemntos que componen el periférico RCC	====== */
